def input(in_msg):
    ...
    in_msg.stop_history_when_smallForward = True
    in_msg.stop_history_when_smallBackward = True
    in_msg.threshold_stop_history_when_small = 0.4
    
    in_msg.px_cut = 0 #set to 0 in validation (want to track cells wherever they are?); else reccomended 70
    ...
    in_msg.outputDirOffline =  '/opt/users/'+in_msg.user+'/PyTroll/scripts//output_coalition2/'
