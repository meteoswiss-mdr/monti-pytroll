...
def input(in_msg):
    ...
    #in_msg.postprocessing_composite=['precip-ir108'] 
    #in_msg.postprocessing_montage = [["MSG_RATE-ir108","cpp_precip-ir108"]]
    in_msg.postprocessing_areas=['ccs4','EuropeCanaryS95']
    in_msg.postprocessing_composite=['cth-ir108', 'cot-ir108', 'cwp-ir108','reff-ir108', 'sds-ir108']    
