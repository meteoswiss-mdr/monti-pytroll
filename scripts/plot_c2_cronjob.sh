...
python postprocessing.py --parea ccs4 -c ["C2rgb-IR_108"] -m [["MSG_C2rgb-IR-108","MSG_CT","MSG_HRoverview","MSG_TRT-radar-convection","MSG_radar-convection","MSG_THX-HRVir108"]] --delay 24 input_coalition2_cronjob
python postprocessing.py --parea ccs4 -c ["C2rgb-IR_108"] -m [["MSG_C2rgb-IR-108","MSG_CT","MSG_HRoverview","MSG_TRT-radar-convection","MSG_radar-convection","MSG_THX-HRVir108"]] --delay 34 input_coalition2_cronjob
