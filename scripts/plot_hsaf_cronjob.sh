...
# create composite 
#python postprocessing.py       --parea ccs4       -c ["h03-HRVir108","radar-HRVir108"]                                                      input_hsaf_cronjob.py
#python postprocessing.py --scp --parea ccs4       -c []                -m [["MSG_radar-HRVir108","MSG_h03-HRVir108"]]                       input_hsaf_cronjob.py
