...
python postprocessing.py --scp --parea EuropeCanaryS95  -c ["h03-ir108","h03-HRV","h03-VIS006ir108"] input_hsaf_cronjob.py
python postprocessing.py --scp --parea odysseyS25       -c ["h03-ir108","h03-HRV","h03-VIS006ir108","RATE-ir108","RATE-HRV","RATE-VIS006ir108"] input_hsaf_cronjob.py
python postprocessing.py --scp --parea odysseyS25       -c '' -m [["MSG_RATE-ir108","MSG_h03-ir108"],["MSG_RATE-HRV","MSG_h03-HRV"],["MSG_RATE-VIS006ir108","MSG_h03-VIS006ir108"]] input_hsaf_cronjob.py
