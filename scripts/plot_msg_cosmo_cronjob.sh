...
echo " "
echo "--------------------------------------------------------"
echo "    python loop_msg.py input_msg_cosmo_cronjob    (parallax corrected 10.8 SEVIRI image)"
python loop_msg.py input_msg_cosmo_cronjob.py $year $month $day $hour 0
echo " "
