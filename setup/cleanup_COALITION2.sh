...
find /data/cinesat/in/cosmo/*nc             -type f -mmin +240 -delete
### echo "cleanup cpp input"
### find /data/cinesat/in/cpp/*nc           -type f -mmin +180 -delete

echo "cleanup COALITION2 output"
find /data/cinesat/out/labels/Label*        -type f -mmin +120 -delete
find /data/cinesat/out/Label*               -type f -mmin +120 -delete
find /data/cinesat/out/20*p                 -type f -mmin +120 -delete
find /data/cinesat/out/C2-BT-forecasts/20*p -type f -mmin +120 -delete
echo "cleanup PYTROLL output"
find /data/cinesat/out/*png                 -type f -mmin +120 -delete
find /data/cinesat/out/*tif                 -type f -mmin +120 -delete
find /data/cinesat/out/ninjo/*tif           -type f -mmin +120 -delete

echo "cleanup decompressed MSG/SEVIRI HRIT files"
find /tmp/SEVIRI_DECOMPRESSED_${LOGNAME}/H-000-MSG* -type f -mmin +65 -delete
find /tmp/SEVIRI_DECOMPRESSED/H-000-MSG*            -type f -mmin +65 -delete
echo "cleanup of decompressed HSAF files"
find /tmp/h03_*_rom.grb                             -type f -mmin +60 -delete
find /tmp/h03B_*_fdk.grb                            -type f -mmin +60 -delete
