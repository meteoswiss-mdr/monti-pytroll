...
def input(in_msg, timeslot=None):
    ...
    #in_msg.areas.append('ccs4')  #background for COALITION-2
    in_msg.areas.append('EuropeCanaryS95')  #background for COALITION-2
    ...
    in_msg.postprocessing_composite=["C2rgb-IR_108", "C2rgb-HRVir108"] # ,"C2rgb-ir108", "C2rgb-HRVir108"
    ...
    #in_msg.scpProducts=["IR_108","_ir108","_vis_with_ir"]  # these images are only needed to create composite, no direct display at SATLive
    #in_msg.scpProducts = ['IR_108c', "radar-convection"]   # list of rgb, composite and montage strings
    in_msg.scpProducts = ["C2rgb-IR_108", "C2rgb-HRVir108"]  
