...
def input(in_msg, timeslot=None):
    ...
    in_msg.areas.append('euroHDready')     # for MLP ANN rainrate combined with Odyssey radar 
    ...
    in_msg.postprocessing_areas=['odysseyS25','euroHDready']
    in_msg.postprocessing_composite=["rrMlp-HRVir108","RATE-HRVir108", "h03b-HRVir108"]
