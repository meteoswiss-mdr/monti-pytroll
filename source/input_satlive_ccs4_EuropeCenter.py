...
def input(in_msg, timeslot=None):
    ...
    in_msg.RGBs.append("IR_108")   # old background of C2
    ...
    in_msg.scpProducts=["WV_062","_ir108","_vis_with_ir","airmass","ash","cloudtop","convection","DayLSConvectionNightMicrophysics",
                        "dust","fog","green_snow","HRgreen_snow","_vis_with_ir","night_fog","DayNaturalColorNightIRoverview",
                        "DayNightMicrophysics","DayNightFog","DayConvectionNightMicrophysics","DayNightOverview",
                        "DaySWconvectionNightMicrophysics","DayHRVVIScloudsNightIRoverview",
