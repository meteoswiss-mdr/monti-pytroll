...
def input(in_msg, timeslot=None):
    ...
    in_msg.scpProducts=["WV_062","_ir108","_vis_with_ir","airmass","ash","cloudtop","convection","DayLSConvectionNightMicrophysics",
                        ...
                        "DayNightMicrophysics","DayNightFog","DayConvectionNightMicrophysics",
                        "DayNightOverview","DaySWconvectionNightMicrophysics","DayHRVVIScloudsNightIRoverview",
                        "h03b-HRVir108", "h03b-VIS006ir108"]
